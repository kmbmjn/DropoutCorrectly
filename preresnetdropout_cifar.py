...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, dropRate=0.0, downsample=None):
...
class PreResNet(nn.Module):
    def __init__(self, depth, num_classes=1000, block_name="BasicBlock", dropRate=0.0):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dropRate=0.0):
        ...
        layers.append(
            block(
                self.inplanes, planes, stride, dropRate=dropRate, downsample=downsample
            )
        )
